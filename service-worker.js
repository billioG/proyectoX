...
const CACHE_NAME = 'projectx-v1.0.77';
...
const LAZY_MODULES = [
  ...
  'js/kpi-engine.js', 'js/lessons.js', 'js/pdf-processor.js', 'js/spelling-duel.js', 'js/game-arena.js', 'js/season-pass.js', 'js/leagues.js',
