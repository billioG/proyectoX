...
export const MOTIVATIONAL_QUOTES = [
    ...
    "El éxito hoy es influir en la vida de un estudiante.",
    "No enseñas lo que sabes, enseñas lo que eres.",
    "Tu aula es el semillero de los sueños del futuro.",
    "La paciencia es la clave del aprendizaje, y tú eres su guardián.",
