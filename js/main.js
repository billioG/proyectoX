...
const MODULE_MAP = {
    ...
    'profile': ['js/profile.js', 'js/badges.js', 'js/kpi-engine.js', 'js/gamification.js', 'js/duels.js', 'js/hangman-duel.js', 'js/timed-math-duel.js', 'js/debug-duel.js', 'js/spelling-duel.js', 'js/companion.js', 'js/tournaments.js', 'js/profile-modals.js', 'js/feed-ui.js', 'js/project-modals.js', 'js/reports.js', 'js/certificates.js'],
    'feed': ['js/projects.js', 'js/gamification.js', 'js/duels.js', 'js/hangman-duel.js', 'js/timed-math-duel.js', 'js/debug-duel.js', 'js/spelling-duel.js', 'js/companion.js', 'js/tournaments.js', 'js/kpi-engine.js', 'js/feed-ui.js', 'js/project-modals.js', 'js/profile-modals.js', 'js/reports.js', 'js/certificates.js'],
